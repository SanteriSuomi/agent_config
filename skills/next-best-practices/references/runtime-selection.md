...
The default Node.js runtime should be used for new routes and pages. Only adopt Edge runtime if the project already uses it or there's a specific requirement.
