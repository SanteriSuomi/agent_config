...
source: https://github.com/subsy/ralph-tui/tree/main/skills/ralph-tui-create-json
...
> **CRITICAL:** The output MUST be a FLAT JSON object with "name" and "userStories" at the ROOT level. DO NOT wrap content in a "prd" object or use "tasks" array. See "Schema Anti-Patterns" section below.
