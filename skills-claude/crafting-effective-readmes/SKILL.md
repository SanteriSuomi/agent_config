...
**Load the right template from `~/.agents/skills-claude/crafting-effective-readmes/references/`.**
...
- `~/.agents/skills-claude/crafting-effective-readmes/references/style-guide.md` — Writing style, anti-patterns, formatting
- `~/.agents/skills-claude/crafting-effective-readmes/references/oss-template.md` — Open source project template
- `~/.agents/skills-claude/crafting-effective-readmes/references/config-template.md` — Config directory template
